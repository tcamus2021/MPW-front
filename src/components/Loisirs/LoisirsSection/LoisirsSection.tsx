 ...
 * @return {JSX.Element}
 */
const LoisirsSection = ({ loisir, triggerOpenDetails }: LoisirsSectionProps): JSX.Element => (
    <button 
    ...
    >
        <div className="loisirs-page__container-item-left">
            ...
            <p className="loisirs-page__container-item-left-title"><FormattedMessage id={loisir.nom} /></p>
        </div>
