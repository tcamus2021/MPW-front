    ...
    return (
        <div>
            ...
            <div className="loisirs-page__container">
                {loisirs.map(loisir => (
                    <LoisirsSection key={loisir.nom} loisir={loisir} triggerOpenDetails={() => setSelectedLoisirs(loisir)} />
                ))}
            </div>
                ...
                {selectedLoisirs && (
                        ...
                        <div className="loisirs-page__modal">
                            <div className="loisirs-page__modal-presentation" style={{ '--loisirs-section--color': selectedLoisirs.color } as CustomCssProperties}>
                                ...
                                <h3 className="loisirs-page__modal-title"><FormattedMessage id={selectedLoisirs.nom} /></h3>
                            </div>
                            <div className="loisirs-page__modal-descriptions">
                                {selectedLoisirs?.descriptions.map(description => (
                                    <p key={uuidv4()} className="loisirs-page__modal-description"><FormattedMessage id={description} /></p>
                                ))}
                            </div>
                        </div>
                    </Modal>
